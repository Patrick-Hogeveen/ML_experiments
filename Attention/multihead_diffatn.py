...
Code from Microsoft unilm respository
...
class MultiheadDiffAttn(nn.Module):
    ...
    def forward(
        ...
        #rotary embedding, going to remove for now as I want to compare this to a vanilla transformer
        #Also not 100% sure how it works
        #need to decide on sin and cos as well
